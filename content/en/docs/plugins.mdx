...
You can create your own Code Agent with your own models, features, tools and other integrations, using the plugin system.
...
That's it. You can now use your own Code Agent.
