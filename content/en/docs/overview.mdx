...
Neovate `['niːəʊveɪt]`<PronounceNeovate /> Code is an open-source Code Agent with built-in AI programming best practices. You can use it to generate code, fix bugs, review code, add tests, and more. You can run it in interactive mode or headless mode, or wrap your own Code Agent via SDK.
