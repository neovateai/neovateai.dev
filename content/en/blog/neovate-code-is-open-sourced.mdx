...
description:
  'We are excited to announce that Neovate Code is now open sourced! Learn about our journey building this AI-powered coding assistant and how it is transforming the developer experience with intelligent code generation, debugging, and optimization.'
date: 2025-09-24
authors:
  - name: Chen Cheng
...
And we created another code agent, [Neovate Code](https://github.com/neovateai/neovate-code), which is open sourced. It's currently mainly a CLI code agent, but we have made the architecture flexible enough to support multiple clients.
