...
2. Set the API key in your environment variable `ANTHROPIC_API_KEY`.
...
2. Set the API key in your environment variable `DEEPSEEK_API_KEY`.
...
2. Set the API key in your environment variable `GOOGLE_API_KEY`.
```bash
...
2. Set the API key in your environment variable `GROQ_API_KEY`.
```bash
...
2. Set the API key in your environment variable `MOONSHOT_API_KEY`.
...
2. Set the API key in your environment variable `IFLOW_API_KEY`.
...
2. Set the API key in your environment variable `OPENAI_API_KEY`.
...
2. Set the API key in your environment variable `OPENROUTER_API_KEY`.
...
2. Set the API key in your environment variable `XAI_API_KEY`.
