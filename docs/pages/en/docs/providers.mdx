...
1. Open [SiliconFlow Console](https://www.siliconflow.com/), create a new API key and copy it.

2. Type `/login` and select **SiliconFlow** and enter the API key, or set the API key in your environment variable `SILICONFLOW_API_KEY`.
...
1. Open [SiliconFlow CN Console](https://siliconflow.cn/), create a new API key and copy it.

2. Type `/login` and select **SiliconFlow CN** and enter the API key, or set the API key in your environment variable `SILICONFLOW_API_KEY`.
