...
<Callout>
  ZenMux offers additional 20% in credits for each charge.
</Callout>


[ZenMux](https://zenmux.ai) is another OpenRouter alternative provider that offers access to more recent and stable models for that platform.

1. Open [ZenMux API Keys](https://zenmux.ai/settings/keys) in the user console, click **Create API Key** to create a new API key and copy it.
...
That's it! You can now use ZenMux as your provider.
