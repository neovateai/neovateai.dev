...
```bash
neovate mcp add --sse <name> <url>
```

e.g.

```bash
neovate mcp add --sse myserver https://a.com/mcp
neovate mcp add --sse myserver https://a.com/mcp --header "Authorization: Bearer 123"
```

### Remote HTTP server

```bash
neovate mcp add <mcp_server_name> <url>
```

e.g.

```bash
neovate mcp add myserver https://a.com/mcp
neovate mcp add myserver https://a.com/mcp --header "Authorization: Bearer 123"
```

Real world example:

```bash
neovate mcp add context7 https://mcp.context7.com/mcp
```
